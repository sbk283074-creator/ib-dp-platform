#!/usr/bin/env python3
"""
Session 2 extractor — Math AA HL Paper 2 (past papers, 2021 May -> 2024.11).
Text-layer extraction (pypdfium2). Fork of extract_paper_aa_p1.py with the
P2-specific 4-alt MS-header detector (adds the "N (a)" no-dot format found in
2021May_TZ1). Produces backend/data/paper_aa_p2_manifest.json (question text +
rendered question_image, answer text + rendered answer_image) and writes the JPGs
to backend/public/figures/paper_aa_hl_p2/<slug>/.
...
MANIFEST = os.path.join(ROOT, "backend/data/paper_aa_p2_manifest.json")
...
PAPERS = [
 ("IB 数学 HL 真题（2006-23）/2021 May/IB 数学 AA  HL  2021.05/Mathematics_analysis_and_approaches_paper_2__TZ1_HL.pdf", "2021May_TZ1", "2021 May TZ1"),
 ("IB 数学 HL 真题（2006-23）/2021 May/IB 数学 AA  HL  2021.05/Mathematics_analysis_and_approaches_paper_2__TZ2_HL.pdf", "2021May_TZ2", "2021 May TZ2"),
 ("IB 数学 HL 真题（2006-23）/2021 Nov/Mathematics_analysis_and_approaches_paper_2__HL.pdf", "2021Nov", "2021 Nov"),
 ("IB 数学 HL 真题（2006-23）/2022 May/Mathematics_analysis_and_approaches_paper_2__TZ1_HL.pdf", "2022May_TZ1", "2022 May TZ1"),
 ("IB 数学 HL 真题（2006-23）/2022 May/Mathematics_analysis_and_approaches_paper_2__TZ2_HL.pdf", "2022May_TZ2", "2022 May TZ2"),
 ("IB 数学 HL 真题（2006-23）/2022 Nov/Mathematics_analysis_and_approaches_paper_2__HL.pdf", "2022Nov", "2022 Nov"),
 ("IB 数学 HL 真题（2006-23）/2023 May/Mathematics_analysis_and_approaches_paper_2__TZ1_HL.pdf", "2023May_TZ1", "2023 May TZ1"),
 ("IB 数学 HL 真题（2006-23）/2023 May/Mathematics_analysis_and_approaches_paper_2__TZ2_HL.pdf", "2023May_TZ2", "2023 May TZ2"),
 ("IB 数学 HL 真题（2006-23）/2023 Nov/Mathematics_analysis_and_approaches_paper_2__TZ1_HL.pdf", "2023Nov_TZ1", "2023 Nov TZ1"),
 ("IB 数学 HL 真题（2006-23）/2023 Nov/Mathematics_analysis_and_approaches_paper_2__TZ2_HL.pdf", "2023Nov_TZ2", "2023 Nov TZ2"),
 ("2024.5HL/Mathematics_analysis_and_approaches_paper_2__TZ1_HL.pdf", "2024_5_TZ1", "2024 May TZ1"),
 ("2024.5HL/Mathematics_analysis_and_approaches_paper_2__TZ2_HL.pdf", "2024_5_TZ2", "2024 May TZ2"),
 ("2024.11HL/Mathematics_analysis_and_approaches_paper_2__HL.pdf", "2024_11", "2024 Nov"),
]

qhead_re = re.compile(r'(?m)^\s*(\d+)\.\s*\[Maximum mark: (\d+)\]')
# MS question-boundary detector. FOUR formats (P1's 3 + P2's no-dot "N (a)"):
#   1. "Question 10" / "Question 10 continued"            -> g1
#   2. "10." (dot, not a decimal)                          -> g2
#   3. "2 METHOD 1" (number + space + METHOD, NO dot)     -> g3
#   4. "6 (a) attempt to find a vector ..." (no dot, space + "(a)")  -> g4
#      ^^^ P2-specific. 2021May_TZ1 Q6 uses this; the 3-alt P1 detector
#      resolved only 5/12 there. Adding g4 -> all 13 P2 papers resolve 12/12.
...
def process(qp_rel, slug, pretty):
    ...
    for idx, n in enumerate(keys):
        ...
        records.append({
            ...
            "source": f"AA HL P2 · {pretty}", "tags": [], "authored_by": "ib",
