// Import physics topic question manifest into the questions table.
...
const MANIFEST = resolve(__dirname, '../data/physics_topic_manifest.json');
...
const tx = db.transaction(() => {
  for (const r of manifest) {
    ...
    insertQuestion.run({
      ...
      authored_by: 'extract_physics_topic.py',
      created_at: now,
    });
    inserted++;
